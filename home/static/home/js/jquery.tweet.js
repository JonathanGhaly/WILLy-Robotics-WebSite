...
(function (factory) {
  ...
  $.fn.tweet = function (o) {
    ...
    function extract_template_data(item) {
      ...
      o.avatar_url = extract_avatar_url(
        item,
      ...
      o.join_text =
        s.join_text == "auto" ? build_auto_join_text(item.text) : s.join_text;
      ...
      o.favorite_url =
        o.twitter_base + "intent/favorite?tweet_id=" + o.tweet_id;
      o.retweeted_screen_name =
        o.retweet && item.retweeted_status.user.screen_name;
      o.tweet_relative_time = relative_time(o.tweet_time);
      o.entities = item.entities
        ? (item.entities.urls || []).concat(item.entities.media || [])
        : [];
      o.tweet_raw_text = o.retweet
        ? "RT @" + o.retweeted_screen_name + " " + item.retweeted_status.text
        : item.text; // avoid '...' in long retweets
      ...
      o.join = s.join_text
        ? t(' <span class="tweet_join">{join_text}</span> ', o)
        : " ";
